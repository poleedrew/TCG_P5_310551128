...
P1B='./nogo --shell --name="poleedrew" --black="T=1000000 thread=4 C=0.3"'
P1W='./nogo --shell --name="poleedrew" --white="T=1000000 thread=4 C=0.3"'
...
P2B="gogui-client 127.0.0.1 65530"
P2W="gogui-client 127.0.0.1 65530"
# other settings
